...
def wind():       
        ...
        ftp.cwd('/climate_environment/CDC/observations_germany/climate/10_minutes/wind/now')          
        ...
        for filename in ftp.nlst():
            #if filename.startswith("10minutenwerte_wind_000"): # download all stations data in Germany
            if filename.startswith("10minutenwerte_wind_"): # download all stations data in Germany
                curr += 1
        ...
        for filename in ftp.nlst():
            if filename.startswith("zehn_now_ff_Beschreibung_"): # 10minutenwerte_SOLAR_
                curr += 1
        ...
        df_2 = pd.read_table("zehn_now_ff_Beschreibung_Stationen.txt", 
        ...
        columns = ['STATIONS_ID', 'MESS_DATUM', 'FF_10', 'DD_10', 
                   'eor', 'geoBreite', 'geoLaenge']  # original
