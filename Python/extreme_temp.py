...
KAFKA_TOPIC = os.environ.get('KAFKA_TOPIC', 'dwd_extreme_temp_10m')
...
def extreme_temp():       
        ...
        ftp.cwd('/climate_environment/CDC/observations_germany/climate/10_minutes/extreme_temperature/now/')          
        ...
        for filename in ftp.nlst():
            #if filename.startswith("10minutenwerte_extrema_temp_0007"): # downlowd 2 or 3 Stations data only
            if filename.startswith("10minutenwerte_extrema_temp_"): # download all stations data in Germany
                curr += 1
        ...
        for filename in ftp.nlst():
            if filename.startswith("zehn_now_tx_Beschreibung_"): # 10minutenwerte_SOLAR_
                curr += 1
        ...
        df_2 = pd.read_table("zehn_now_tx_Beschreibung_Stationen.txt", 
        ...
        columns = ['STATIONS_ID', 'MESS_DATUM', 'TX_10', 'TX5_10', 
                    'TN_10', 'TN5_10', 'eor', 'geoBreite', 'geoLaenge'] 
